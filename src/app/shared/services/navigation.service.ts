    ...
    defaultMenu: IMenuItem[] = [
      {
        ...
        icon: 'i-Token-',
        sub: [
          { icon: 'i-Bell', name: 'Dashboard', state: '/user-dashboard/user-dashboard', type: 'link' },
          { icon: 'i-Split-Horizontal-2-Window', name: 'Applications', state: '/user-dashboard/applications', type: 'link' },
          {
            icon: 'i-Arrow-Right-in-Circle',
            name: 'Applicant Profile',
            type: 'dropDown',
            sub: [
              { name: 'Credit Information', state: '/user-dashboard/credit-score', type: 'link' },
              { name: 'Subject Information', state: '/user-dashboard/subject-property', type: 'link' },
            ]
          },
          { icon: 'i-ID-Card', name: 'Loan Options', state: '/user-dashboard/loan-option', type: 'link' },
          { icon: 'i-Line-Chart-2', name: 'Documents', state: '/user-dashboard/documents', type: 'link' },
          { icon: 'i-Credit-Card', name: 'Lender Profile', state: '/user-dashboard/lender-profile', type: 'link' },
          { icon: 'i-Full-Cart', name: 'Borrower Profile', state: '/user-dashboard/borrower-profile', type: 'link' },
          // { icon: 'i-Duplicate-Window', name: 'Subject Property', state: '/user-dashboard/subject-property', type: 'link' },
          { icon: 'i-Speach-Bubble-3', name: 'My Account', state: '/user-dashboard/my-account', type: 'link' },
        ]
      },
      ...
      {
          name: '',
          description: 'You can create new application here',
          type: 'dropDown',
          icon: 'i-File-Clipboard-File--Text',
          sub: [
              { icon: 'i-Width-Window', name: 'New Application', state: '/forms/wizard', type: 'link' },
        ...
        // {
        //     name: 'UI kits',
        //     description: 'This is the UI kits.',
        //     type: 'dropDown',
        //     icon: 'i-Library',
        //     sub: [
      ...
      // },
        ...
        {
            name: 'Sessions',
            description: 'This is the sessions page',
            type: 'dropDown',
            icon: 'i-Administrator',
            sub: [
                { icon: 'i-Add-User', name: 'Sign up', state: '/sessions/signup', type: 'link' },
                { icon: 'i-Add-User', name: 'Broker Sign up', state: '/sessions/brokerSignup', type: 'link' },
