...
export class SidebarCompactComponent implements OnInit {
  ...
  selectOriginalItem() {
     let oItem = localStorage.getItem('selectedBarItem')
    this.selectedItem = JSON.parse(oItem)
    // this.setActiveMainItem(this.selectedItem)
    // console.log(oItem)
  }
  ...
  onClickChangeActiveFlag(item) {
    localStorage.setItem('selectedBarItem', JSON.stringify(item))
    this.setActiveMainItem(item);
  }
